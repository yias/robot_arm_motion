...
bool GaussianMixture::saveMuAndSigma(const char fileMu[], const char fileSigma[], Matrix outData, Matrix outSigma[])
{
...
double GaussianMixture::pdfStateLite(Vector &x,int & state)
{
